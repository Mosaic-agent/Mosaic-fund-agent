...
<footer>
  <p>Generated by <a href="https://github.com/Mosaic-agent/Mosaic-fund-agent" style="color:#60a5fa;text-decoration:none;" target="_blank">Mosaic Fund Agent</a> · {gen_date} · Data sources: MFAPI, NSE iNAV API, Yahoo Finance, ClickHouse (market_data)</p>
